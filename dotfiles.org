...
#+BEGIN_SRC emacs-lisp
  ...
  ;; gcc updates require libgccjit to update as well
  ;; until both are updated => disable native compilation
...
*** Font
#+BEGIN_SRC emacs-lisp
  (setq nri/font "Roboto Mono")
  (setq nri/font-size 14)
  (setq nri/font-size-hidpi 22)

  ;; font
  (set-frame-font nri/font nil t)
  ;; change font size in hook, fixes size reset after changing themes
  ;; (set-face-attribute 'default nil :height (* 10 (if (equal "merkur" (system-name)) nri/font-size-hidpi nri/font-size)))
  ...
  (add-hook 'after-load-theme-hook
            (lambda () (set-face-attribute 'default nil :height (* 10 (if (equal "merkur" (system-name)) nri/font-size-hidpi nri/font-size)))))
#+END_SRC
*** Theme
**** Spacemacs Theme
#+BEGIN_SRC emacs-lisp
